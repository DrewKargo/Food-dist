...
function timer(id, deadLine) {
	...
	function setClock(selector, endtime) {
		...
		function updateClock() {
			...
			//если нужно добавить в таймер 0 перед цифрой,которая меньше 10,нужно подставить функцию
...
window.addEventListener('DOMContentLoaded', () => {
	const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId), 15000);

	(0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('.timer', '2023-01-01');
	(0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('.modal', '[data-modal]');
